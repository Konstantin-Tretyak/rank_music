                ...
                <div class="sort">
                    <form class="sort_filter">
                        ...
                        <select class="form-control" name="sort">
                            <option value="place_in_rank" @if(isset($filters['sort']) && $filters['sort']=="place_in_rank") selected="selected" @endif > По рейтингу </option>
                            <option value="name" @if(isset($filters['sort']) && $filters['sort']=="name") selected="selected" @endif > По названию </option>
                            <option value="performer" @if(isset($filters['sort']) && $filters['sort']=="performer") selected="selected" @endif > По исполнителю </option>
                            <option value="composer" @if(isset($filters['sort']) && $filters['sort']=="composer") selected="selected" @endif > По композитору </option>
                            <option value="duration" @if(isset($filters['sort']) && $filters['sort']=="duration") selected="selected" @endif > По длительности </option>
