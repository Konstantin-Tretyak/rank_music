        ...
        *******************************/
        ...
        var methods = {
            ...
            *******************************/
            ...
            scroll: function(reverse) {
                ...
                if(canNavigate == true) {
                    ...
                    if(!settings.infinite) {
                        ...
                        var scrollDistance = (itemsWidth+10) * itemsToScroll;
            ...
            Utility Functions
            *******************************/
            ///TODO: заменить десятки на margin
            getCurrentItemWidth: function() {
                return (object.parent().width())/itemsVisible-10;
            },
            ...
            calculateNonInfiniteRightScroll: function(toScroll){
                ...
                methods.clearDisabled();
                var negativeOffsetLimit = (itemCount - itemsVisible) * (itemsWidth+10);
        ...
        _starClick: function (e) {
            ...
            self._listenClick(e, function (ev)
            {
                ...
                ({
                    ...
                    method: 'POST',
                    data: {'value':self.$element.val(),'song_id':self.$element.data('songId')},
                    success: function(result){notify('Вы проголосовали', 'success')},
                    error: function ( jqXHR )
                    {
                        app.defaultAjaxError(self.$element, jqXHR);
                    }
                })
            });
        },
        /*_sendRankValue: function () {
